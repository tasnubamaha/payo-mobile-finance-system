...
* 2. get the moeny user wants to add
* also, get the pin number provided
* 3. verify the pin number. for wrong pin number, => failed to add for the right pin number, allow 
* to add for right pin number, allow to add the number to the account balance
